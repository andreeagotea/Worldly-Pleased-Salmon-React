                            ...
                            {props.page1Description ?? (
                              <Fragment>
                                <span className="navbar8-text18 thq-body-small">
                                  Explore nossa página inicial para saber mais
                            ...
                            {props.page2Description ?? (
                              <Fragment>
                                <span className="navbar8-text21 thq-body-small">
                                  Descubra os cursos disponíveis e encontre o
                            ...
                            {props.page3Description ?? (
                              <Fragment>
                                <span className="navbar8-text24 thq-body-small">
                                  Saiba mais sobre o processo de matrícula e
                            ...
                            {props.page4Description ?? (
                              <Fragment>
                                <span className="navbar8-text17 thq-body-small">
                                  Acesse nossos recursos para obter informações
                  ...
                  <div className="navbar8-content5">
                    ...
                    <span>
                      {props.page1Description ?? (
                        <Fragment>
                          <span className="navbar8-text18 thq-body-small">
                            Explore nossa página inicial para saber mais sobre
                            nossa plataforma.
                          </span>
                        </Fragment>
                      )}
                  ...
                  <div className="navbar8-content6">
                    ...
                    <span>
                      {props.page2Description ?? (
                        <Fragment>
                          <span className="navbar8-text21 thq-body-small">
                            Descubra os cursos disponíveis e encontre o que
                  ...
                  <div className="navbar8-content7">
                    ...
                    <span>
                      {props.page3Description ?? (
                        <Fragment>
                          <span className="navbar8-text24 thq-body-small">
                            Saiba mais sobre o processo de matrícula e como
                            garantir sua vaga.
                          </span>
                        </Fragment>
                      )}
...
Navbar8.defaultProps = {
  ...
  page4: undefined,
  page3ImageSrc:
    'https://images.unsplash.com/photo-1540921002383-b2a7ff6a716d?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w5MTMyMXwwfDF8cmFuZG9tfHx8fHx8fHx8MTcyNDMyOTgyNnw&ixlib=rb-4.0.3&q=80&w=1080',
  action2: undefined,
  link2Url: 'https://www.teleporthq.io',
  logoAlt: 'Logo da Plataforma',
  page2ImageAlt: 'Imagem dos Cursos',
  page3ImageAlt: 'Imagem da Matrícula',
  link3Url: 'https://www.teleporthq.io',
  page4Description: undefined,
  page1Description: undefined,
  page3: undefined,
  page2ImageSrc:
    'https://images.unsplash.com/photo-1606056738858-3de6f85f8a14?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w5MTMyMXwwfDF8cmFuZG9tfHx8fHx8fHx8MTcyNDMyOTgyNnw&ixlib=rb-4.0.3&q=80&w=1080',
  linkUrlPage4: 'https://www.teleporthq.io',
  link2: undefined,
  linkUrlPage3: 'https://www.teleporthq.io',
  linkUrlPage2: 'https://www.teleporthq.io',
  page1ImageSrc:
    'https://images.unsplash.com/photo-1589995635011-078e0bb91d11?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w5MTMyMXwwfDF8cmFuZG9tfHx8fHx8fHx8MTcyNDMyOTgyNXw&ixlib=rb-4.0.3&q=80&w=1080',
  linkUrlPage1: 'https://www.teleporthq.io',
  link1Url: 'https://www.teleporthq.io',
  page2Description: undefined,
  logoSrc:
    'https://aheioqhobo.cloudimg.io/v7/_playground-bucket-v2.teleporthq.io_/84ec08e8-34e9-42c7-9445-d2806d156403/fac575ac-7a41-484f-b7ac-875042de11f8?org_if_sml=1&force_format=original',
  page1ImageAlt: 'Imagem da Página Inicial',
  page4ImageAlt: 'Imagem dos Recursos',
  link1: undefined,
  action1: undefined,
  page3Description: undefined,
  page4ImageSrc:
    'https://images.unsplash.com/photo-1526948531399-320e7e40f0ca?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w5MTMyMXwwfDF8cmFuZG9tfHx8fHx8fHx8MTcyNDMyOTgyNnw&ixlib=rb-4.0.3&q=80&w=1080',
  link3: undefined,
  page2: undefined,
  page1: undefined,
}
