        ...
        <div className="pricing14-section-title">
          ...
          <div className="pricing14-content">
            <h2>
              {props.heading1 ?? (
                <Fragment>
                  <h2 className="pricing14-text207 thq-heading-2">
                    Pricing plan
                  </h2>
                </Fragment>
              )}
              ...
              <div className="pricing14-price12">
                <div className="pricing14-price13">
                  ...
                  <p>
                    {props.plan2Yearly ?? (
                      <Fragment>
                        <p className="pricing14-text173 thq-body-large">
              ...
              <div className="pricing14-price18">
                <div className="pricing14-price19">
                  <span>
                    {props.plan21 ?? (
                      <Fragment>
                        <span className="pricing14-text156 thq-body-large">
                          Business plan
                        </span>
                      </Fragment>
                    )}
              ...
              <div className="pricing14-price20">
                <div className="pricing14-price21">
                  ...
                  <h3>
                    {props.plan3Price1 ?? (
                      <Fragment>
                        <h3 className="pricing14-text182 thq-heading-3">
                          $499/yr
                        </h3>
                      </Fragment>
                    )}
