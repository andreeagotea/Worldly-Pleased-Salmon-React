          ...
          <div className="steps2-container3">
                ...
                {props.step1Description ?? (
                  <Fragment>
                    <span className="steps2-text26 thq-body-small">
                      Crie uma conta na plataforma para ter acesso a todos os
                ...
                {props.step2Description ?? (
                  <Fragment>
                    <span className="steps2-text25 thq-body-small">
                      Navegue pela variedade de cursos oferecidos e encontre o
                      que melhor se adequa às suas necessidades de aprendizado.
                    </span>
                  </Fragment>
                )}
              </span>
                ...
                {props.step3Description ?? (
                  <Fragment>
                    <span className="steps2-text31 thq-body-small">
                      Acesse informações detalhadas sobre os cursos, incluindo
                      conteúdo programático, carga horária e requisitos.
                    </span>
                  </Fragment>
                )}
              </span>
            ...
            <div className="steps2-container7 thq-card">
              <h2>
                {props.step4Title ?? (
                  <Fragment>
                    <h2 className="steps2-text28 thq-heading-2">Matrícula</h2>
                  </Fragment>
                )}
              </h2>
              <span>
                {props.step4Description ?? (
                  <Fragment>
                    <span className="steps2-text30 thq-body-small">
                      Matricule-se nos cursos desejados de forma simples e
                      rápida, garantindo sua vaga para iniciar seus estudos.
                    </span>
                  </Fragment>
                )}
              </span>
